...
/*
    ...
    Combat system: Roll a number d10 dice equal to relevant stat system. 8,9,and 10s count as a success for an attack. The same system
     ...
     Trait system: Modifiers will be conferred to the player as well as to enemies based off of their traits. Rank and skillsets/body traits
        ...
        */
        ...
        while (running) {
            ...
            while (oppStam > 0) {
                ...
                System.out.println("\t6. Tap to Acknowledge loss");
                //Selection Input
                System.out.print("Action Number >>");
                int input = keyIn.nextInt();
                //can use switch instead... may make better option
                switch (input) {
                    case 1:
                    ...
                    case 2:
                        ...
                        damTaken = opponent.dexAttack() - playerOne.defSkill;
                        damDealt = playerOne.dexAttack() - opponent.defSkill;
                        oppStam -= damDealt;
                        stam -= damTaken;
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        System.out.println("You know you are in over your head and tap to save your energy");
                        continue Game;
                    }
                //Exit current session if players stam reaches zero or less
                if(stam < 1) {
